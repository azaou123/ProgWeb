    ...
    <div class="d-flex " style="height: 100%">
        ...
        <div class="col-md-9 p-5" style="background-color:#EFEFEF">
            <div class="p-1 d-flex align-items-center justify-content-between "
                ...
                <h4 class="" style="color:#967117; "> FabLab </h4>
                @include('dropdown_admin')
            </div>
            <br>
            <h3 class=" mb-5">New FabLab</h3>
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                <h3 class="text-dark mb-5 "> FabLab</h3>
                <form method="post" enctype="multipart/form-data" action="/updateFablab/{{$dataF->id}}">
                    @csrf
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="mb-3">
                                <label for="" class="form-label" style="color:grey">Titre</label>
                                <input type="text" class="form-control" value="{{$dataF->title_fablab}}" name="title_fablab" id="lastname" placeholder="Your title">
                            </div>
                            <div class="col-12 mb-4">
                                <div class="mb-3">
                                    <label for="lastname" class="form-label" style="color:grey">Description</label>
                                    <textarea class="form-control" rows="5" name="description_fablab" id="comment" placeholder="Your description...">{{$dataF->description_fablab}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="mb-3">
                                ...
                                <input class="form-control rounded" name="image_fablab" type="file" id="avatar"
                                    accept="image/png, image/jpeg" placeholder="Your file...">
                            </div>
