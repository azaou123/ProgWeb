    ...
    <div class="d-flex " style="height: 100%;">
        ...
        <div class="col-md-9 p-5" style="background-color:#EFEFEF">
            ...
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                ...
                <form method="post" action="/storeStudentExtchange">
                    @csrf
                    <div class="row">
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="lastname" class="form-label">Description</label>
                              <input type="text" class="form-control" name="description" id="lastname">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                        ...
                        <div class="form-group m-5 ">
                            <label for="student_id" class="mb-4">Students engaged in the exchange :</label></br>
                            @foreach($students as $student)
                                <input class="mx-5 form-check-input" name="students[]" type="checkbox" value="{{$student->id}}" id="{{$student->firstname}} {{$student->lastname}}">
