    ...
    <div class="d-flex " style="height: 100%">
        ...
        <div class="col-md-9 p-5" style="background-color:#EFEFEF">
            ...
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                ...
                <form method="post" enctype="multipart/form-data" action="/storeResearchProject">
                    @csrf
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="mb-3">
                                <label for="" class="form-label" style="color:grey">Title</label>
                                <input type="text" class="form-control" id="lastname" name="title" placeholder="Your title">
                            </div>
                            <div class="col-12 mb-4">
                                <div class="mb-3">
                                    <label for="lastname" class="form-label" style="color:grey">Description</label>
                                    <textarea class="form-control" name="description" rows="5" id="comment" placeholder="Your description..."></textarea>
                                </div>
                            </div>
