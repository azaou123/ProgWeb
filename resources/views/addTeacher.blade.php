...
<body>
    <div class="d-flex " style="height: 100%">
        ...
        <div class="p-1 d-flex align-items-center justify-content-between " style="background-color:#EFEFEF;margin-top:-30px">
                <h4 class="" style="color:#967117 " > New Teacher </h4>
                @include('dropdown_admin')
            </div>
            <br>
            <h3 class="text-dark mb-5">Add Teacher</h3>
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                <h3 class="text-dark mb-5"> Teacher</h3>
                <form method="post" action="/storeTeacher">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="speciality" id="fname">
                             </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
