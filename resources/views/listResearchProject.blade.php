...
<head>
    ...
    <title>Research Project List</title>
        ...
        <div class="col-md-9 pt-5 px-5" style="background-color:#EFEFEF">
            <div class="px-2 border rounded shadow bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="text-dark">Research Projects List</h3>
            ...
            <div class="d-flex align-items-center mt-4">
                <div class="col-5 d-flex justify-content-start">
                    <div class="mt-3 py-2 d-flex rounded" style="">
                        ...
                        <a href="ResearchProjects/create" class="btn btn-filter1 rounded" style="">ADD NEW <i class="bi bi-plus-lg text-light ms-4"></i></a>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col d-flex justify-content-center">
                                <div class="input-group rounded" style="border:2px solid #800000; font-weight: 500;">
                                    <input class="form-control border-0" style="color:#800000;font-weight: 500;" type="search" value="Title">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-end">
                                <a href="/ResearchProjects/{{$project->id}}/edit" class="mt-1"><i class="bi bi-arrow-clockwise me-2"></i></a>
                                <form action="/destroyResearchProject/{{$project->id}}" method="POST"> 
                                    @csrf
                                    @method('delete')   
