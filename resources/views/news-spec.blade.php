...
<body>
    ...
    <div class="container">
        <div class="liens-url p-5">
            ...
            >
            <a href="" class="lien mx-2" style="color: #800000">News</a>

            <a href="" class="text-secondary">/ {{$news->title}}</a>
        </div>
    </div>
    ...
    <div class="container">
        <div class="p-5">
            ...
            <div class="d-flex justify-content-center">
                <img src="{{asset('images/'.$news->image)}}" alt="" class="img-fluid w-50 align-self-center">
            </div>
            <div class="row mt-4">
                <div class="col-9">
                    <p class="h5 my-3" style="text-align: justify">
                       {{$news->description}}
                    </p>
                   
                    <h5 style="margin-top: 50px">SHARE</h5>
                    <div class="h4 mt-5" style="color:#c78735">
                ...
                <div class="col-3">
                    <h4 class="border-bottom border-dark pb-3">Latest news</h4>
                    @foreach ($allnews as $ne)
                    <div class="border-bottom border-dark p-3">
                        <p class="pt-1 fw-bold">{{date('l, F jS, Y, h:i', strtotime($ne->created_at))}}</p>
                        <a class="nav-link" href="/news-space/{{$ne->id}}" class="mt-3 fw-bold" style="text-align: justify; color: #c78735">{{$ne->title}}</a>
                    </div>
                    @endforeach
