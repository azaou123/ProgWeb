        ...
        <div class="col-md-9 pt-5 px-5" style="background-color:#EFEFEF">
            <div class="px-2 border rounded shadow bg-white">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="text-dark">FabLabs List</h3>
            ...
            <div class="d-flex align-items-center mt-4">
                <div class="col-5 d-flex justify-content-start">
                    <div class="mt-3 py-2 d-flex rounded" style="">
                        ...
                        <a href="Fablabs/create" class="btn btn-filter1 rounded" style="">ADD NEW <i class="bi bi-plus-lg text-light ms-4"></i></a>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-end">
                                <a href="/Fablabs/{{$fablab->id}}/edit" class="mt-1"><i class="bi bi-arrow-clockwise me-2"></i></a>
                                <form action="/destroyFablab/{{$fablab->id}}" method="POST"> 
                                    @csrf
                                    @method('delete')   
