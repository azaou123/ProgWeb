    ...
    <section class="mt-4">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="col-1">
                    <h3 style="color: brown; opacity:2 ; font-style: oblique;">Workshops</h3>
                    <hr style=" border-top: 3px solid brown; opacity:1" class="display-1"><br><br><br><br><br><br>
                </div><br>
                <div class="col-11">
            ...
            <div class="row">
                ...
                <div class="col-10 ">
                    <div class="shadow-sm p-4 mb-5 bg-body rounded d-flex justify-content-between"
                        ...
                        <input type="date" style="width:300px; color:#c78735;border:2px solid #c78735 ;font-weight:900;"
                            class="pe-7 ps-4 p-3">
