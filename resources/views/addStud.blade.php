    ...
    <div class="d-flex " style="height: 100%;">
        ...
        <div class="p-1 d-flex align-items-center justify-content-between " style="background-color:#EFEFEF;margin-top:-30px">
            ...
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                ...
                <form method="post" action="/storeStudent">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nationality" id="fname">
                             </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                              <label for="fname" class="form-label" style="color:grey">Date of Birth</label>
                              <input type="date" class="form-control" name="dateBirthday" id="fname">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                        ...
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              ...
                              <input type="phone" class="form-control" name="tel" id="phone">
                            </div>
                        </div>
                    </div>
