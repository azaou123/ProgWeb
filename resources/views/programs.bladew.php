                            ...
                            <div class="accordion-body" style=" background-color: #ffffff !important;">
                                ...
                                <section class=" mt-4">
                                    <div class="container-fluid"
                                        style="background-color:#800000 ;border: 2px solid #800000">
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="py-4 px-5">
                                                    ...
                                                    <div class="d-flex" style="height: 3rem">
                                                        <select name="" id=""
                                                            style="color:#000000; border:2px solid  #FFFFFF; background-color: #FFFFFF ;font-weight: bold;font-size:20px; border-radius:4px; width: 10rem;"
                                                            class="me-2">
                                                ...
                                                <div class="my-4 ms-5"style="">
                                                    ...
                                                    <form id="form">
                                                        <div class="d-flex" style="height: 3rem;">
                                                            ...
                                                            style=" border-radius:7px;border:4px solid  #FFFFFF" class="me-2">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body" style=" background-color: #ffffff !important;">
                                ...
                                <section class=" mt-4">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="py-4 px-5">
                                                    ...
                                                    <div class="d-flex" style="height: 3rem">
                                                        ...
                                                        <input type="date"
                                                            style="color:#000000; border:2px solid  #FFFFFF; background-color: #FFFFFF ;font-weight: bold;font-size:20px;  border-radius:4px"
                                                            class="me-2" class="pe-2 ps-2">
                                                        <button
                                                            class="btn btn-filter"style="color:#000000; border:2px solid  #FFFFFF; background-color: #FFFFFF ;font-weight: bold;border-radius:4px"
                                    ...
                                    <section class="container mt-5">
                                        <div class="row">
                                            @foreach($dataCulturel as $dc)
                                            <div class="col-lg-4 my-2">
                                                <div class="card"
                                                    style="width: 100%;height: 34rem; box-shadow: 4px 3px 8px 1px #969696;-webkit-box-shadow: 4px 3px 8px 1px #969696;">
                                                    <img class="w-100" src="{{asset('images/'.$dc->image_program_C)}}" alt="image">
                                                    <div class="card-body ">
                                                        <div class="d-flex justify-content-between">
                                                            <span class="" style="font-size: 10px;"><i class="bi bi-calendar-fill "></i><span class="mx-3">{{date('l, F jS, Y', strtotime($dc->Date))}}</span></span>
                                                            
                                                        </div>
                                                        <div class="d-flex align-items-start flex-column">
                                                            <h5 class="card-title">{{$dc->title}}</h5>
                                                            <p class="card-text" style="text-align: justify; font-size: 12px; height: 7rem;">{{$dc->description}}</p>
                                                            <!-- <a href="#"
                                                                class="btn btn-news mb-auto">Learn More ></a> -->
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- <section style="margin-top:100px;margin-bottom:40px">
                                        <div class="conatainer " style=" text-align:center;">
                                            ...
                                            <button type="button"
                                                class="btn btn-primary btn-lg align-items-center"style="background-color:#800000 !important;border:#800000;">Load
                                                more</button>
                                        </div>
                                        ---------fin row ------------------------------>
                                    <!-- </section> --> 
