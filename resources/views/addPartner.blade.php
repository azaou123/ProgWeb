...
<body>
    <div class="d-flex " style="height: 100%;">
        ...
        <div class="p-1 d-flex align-items-center justify-content-between " style="background-color:#EFEFEF;margin-top:-30px">
                <h4 class="" style="color:#967117 " > New Partner </h4>
                @include('dropdown_admin')
            </div>
            <br>
            <h3 class="text-dark mb-5">Add Partner</h3>
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                <h3 class="text-dark mb-5">Partner</h3>
                <form method="POST" enctype="multipart/form-data" action="/storePartner">
                    @csrf
                    <div class="row">
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="name" class="form-label" style="color:grey">Name</label>
                              <input type="text" name="name_company" class="form-control" id="name">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="function" class="form-label" style="color:grey">Function</label>
                              <input type="text" name="function_company" id="function" class="form-control">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                              ...
                              <input type="email" class="form-control" name="email_company" id="email">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                        ...
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              ...
                              <input type="phone" class="form-control" name="fax" id="phone">
                            </div>
                        </div>
                        @method('PUT')
                        <div class="col-6 mb-4">
