    ...
    <div class="d-flex " style="height: 100%;">
        ...
        <div class="p-1 d-flex align-items-center justify-content-between " style="background-color:#EFEFEF;margin-top:-30px">
            ...
            <div class="p-5 w-100 mx-auto" style="background-color:white;">
                ...
                <form method="POST" enctype="multipart/form-data" action="/updateWorkshop/{{$dataW->id}}">
                    @csrf
                    <div class="row">
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="" class="form-label" style="color:grey">Title</label>
                              <input type="text" name="title" value="{{$dataW->title}}" class="form-control" id="">
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              ...
                              <select name="university" id="" class="form-select">
                                <option value=""></option>
                                <option value="UCA" {{ $dataW->university == 'UCA' ? 'selected' : '' }}>UCA</option>
                                <option value="DHBW" {{ $dataW->university == 'DHBW' ? 'selected' : '' }}>DHBW</option>
                              </select>
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              ...
                              <input type="text" name="city" value="{{$dataW->city}}" class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="" class="form-label" style="color:grey">Country</label>
                              <input type="text" name="country" value="{{$dataW->country}}" class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                            <label for="" class="form-label" style="color:grey">Date Start</label>
                              <input type="date" id="" name="date_start" value="{{$dataW->date_start}}" class="form-control">
                             </div>
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                              <label for="" class="form-label" style="color:grey">Date End</label>
                              <input type="date" name="date_end" value="{{$dataW->date_end}}" class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              <label for="" class="form-label" style="color:grey">Type</label>
                              <input type="text" name="type" value="{{$dataW->type}}" class="form-control" id="">
                            </div>
                        </div>
                        <div class="col-6 mb-4">
                            <div class="mb-3">
                              ...
                              {{-- <input type="file" name="image_workshop" class="form-control" id=""> --}}
                                <input class="form-control" value="{{$dataW->image_workshop}}" type="file" name="image_workshop" id="formFile">
                            </div>
                        </div>
                        <div class="col-12 mb-4">
                            <div class="mb-3">
                              <label for="" class="form-label" style="color:grey">Description</label>
                                <textarea  id="" name="description" cols="30" rows="10" class="form-control">{{$dataW->description}}</textarea>
                            </div>
                        </div>
                    </div>
